...
{
    [Table("Facility")]
    [Index("ReFormNo", Name = "UQ__Facility__8E6079845E297BBE", IsUnique = true)]
    [Index("FaName", Name = "UQ__Facility__E1CFB4A23BE9488F", IsUnique = true)]
    [Index("FaNumber", Name = "UQ__Facility__F093DB673BE0081A", IsUnique = true)]
    public partial class Facility
    {
        public Facility()
        {
            AgentsPoints = new HashSet<AgentsPoint>();
            Buildings = new HashSet<Building>();
            CastData = new HashSet<CastDatum>();
            HelpMaterials = new HashSet<HelpMaterial>();
            Machines = new HashSet<Machine>();
            ProCapacities = new HashSet<ProCapacity>();
            RelevantDocs = new HashSet<RelevantDoc>();
            RowMaterials = new HashSet<RowMaterial>();
            SafetySecurities = new HashSet<SafetySecurity>();
            SecondaryActs = new HashSet<SecondaryAct>();
            SiteReasons = new HashSet<SiteReason>();
            Transportations = new HashSet<Transportation>();
            VisitsTraffics = new HashSet<VisitsTraffic>();
        ...
        [MaxLength(8, ErrorMessage = "يجب ان لايزيد رقم السيار عن 15 رقم")]
        [MinLength(8, ErrorMessage = "يجب ان لايقل رقم السيار عن 7 ارقام")]
        ...
        public double? FaLongitude { get; set; }



        [Required(ErrorMessage = "يرجى إدخال دائرة الطول الذي تقع عليىة المنشأة")]
        public double? FaLatitude { get; set; }


        [Column("Is_Deleted")]
        public bool IsDeleted { get; set; }

        public int FaReference { get; set; }
        ...
        public virtual Request ReFormNoNavigation { get; set; } = null!;
        [InverseProperty("Fa")]
        public virtual ICollection<AgentsPoint> AgentsPoints { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<Building> Buildings { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<CastDatum> CastData { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<HelpMaterial> HelpMaterials { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<Machine> Machines { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<ProCapacity> ProCapacities { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<RelevantDoc> RelevantDocs { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<RowMaterial> RowMaterials { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<SafetySecurity> SafetySecurities { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<SecondaryAct> SecondaryActs { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<SiteReason> SiteReasons { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<Transportation> Transportations { get; set; }
        [InverseProperty("Fa")]
        public virtual ICollection<VisitsTraffic> VisitsTraffics { get; set; }
        [InverseProperty("Fa")]
