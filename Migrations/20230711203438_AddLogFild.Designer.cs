...
namespace IndustrialContoroler.Migrations
{
    ...
    [Migration("20230711203438_AddLogFild")]
    partial class AddLogFild
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.HelpMaterial", b =>
                {
                    ...
                    b.Property<double?>("HmPercentInPro")
                        .HasColumnType("float")
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.LogFieldVisitForms", b =>
                {
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.Noti", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.Notification", b =>
                {
                    ...
                    b.Property<int?>("LogFieldVisitFormsLogId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LogFieldVisitFormsLogId");
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.Request", b =>
                {
                    ...
                    b.HasIndex(new[] { "ReSuemNo" }, "UQ__Request__44C63773E9ED83A5")
                        .IsUnique()
                        .HasFilter("[re_suemNo] IS NOT NULL");
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.RowMaterial", b =>
                {
                    ...
                    b.Property<double?>("RmPercentInPro")
                        .HasColumnType("float")
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.LogFieldVisitForms", b =>
                {
                    b.HasOne("IndustrialContoroler.Models.Facility", "facility")
                        .WithMany()
                        .HasForeignKey("FaId")
            ...
            modelBuilder.Entity("IndustrialContoroler.Models.Notification", b =>
                {
                    b.HasOne("IndustrialContoroler.Models.LogFieldVisitForms", null)
                        .WithMany("Notifications")
                        .HasForeignKey("LogFieldVisitFormsLogId");
